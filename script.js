document.addEventListener("DOMContentLoaded", () => {
  ...
  function generateInvoice() {
    ...
    const invoiceDate = document.getElementById("invoice-date").value;  // Get selected date
  ...
  function downloadPDF() {
    ...
    const invoiceDate = document.getElementById("invoice-date").value;  // Use selected date
    ...
    logoImage.onload = function () {
            ...
            columns: [
              {
                stack: [
                  ...
                  {
                    text: `Date: ${invoiceDate}`,  // Use selected date
                    style: "subheader",
                  },
                ],
              },
      ...
      pdfMake.createPdf(dd).download(`invoice_${invoiceNumber}.pdf`);
    };
  }
